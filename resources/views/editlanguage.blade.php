    ...
    @endif
       ...
       <div style="position : relative; top : 30px; margin : auto; background-color : lightgrey; box-shadow : 0 4px 5px rgb(0 0 0 / 50%); width : 550px;">
            <div style="margin : 30px; padding-top : 30px;">
                <form action="{{route('editlang')}}" method="POST">
                    @csrf
                    <h6><strong>Sunting Jenis Bahasa</strong></h6>
                    ...
                    <input type="text" readonly="readonly" class="form-control" placeholder="id language" aria-label="langid" name="id" aria-describedby="basic-addon1" value="{{ $lang->id }}">
                    </div>
                    ...
                    <input type="text" class="form-control" placeholder="Nama baru Jenis Bahasa" aria-label="langname" name="type_lang" aria-describedby="basic-addon1" value="{{ $lang->type_lang }}">
                    </div>
