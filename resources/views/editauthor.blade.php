    ...
    @endif
       ...
       <div style="position : relative; top : 30px; margin : auto; background-color : lightgrey; box-shadow : 0 4px 5px rgb(0 0 0 / 50%); width : 550px;">
            <div style="margin : 30px; padding-top : 30px;">
                <form action="{{route('editauth')}}" method="POST">
                    @csrf
                    <h6><strong>Sunting Pengarang</strong></h6>
                    ...
                    <input type="text" readonly="readonly" class="form-control" placeholder="id author" aria-label="authorid" name="id" aria-describedby="basic-addon1" value="{{ $author->id }}">
                    </div>
                    ...
                    <input type="text" class="form-control" placeholder="Nama baru pengarang" aria-label="authorname" name="name" aria-describedby="basic-addon1" value="{{ $author->name }}">
                    </div>
