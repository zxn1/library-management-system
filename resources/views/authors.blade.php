...
<div style="border-style : solid; border-width : 1px; border-color :#428bca; margin : 30px; border-radius : 13px; background : radial-gradient(ellipse at center, #e5e5e5 0%, #ffffff 100%);">
    <div style="height : 60px; width : 100%; background-color : #428bca;border-top-left-radius: 13px; border-top-right-radius: 13px;">
        <h5 style="font-family : Montserrat; color : white; position : relative; top : 12px; left : 20px;">Semua Pengarang</h5>
    </div>
        <div class="container">
        ...
        <form action="{{route('authorssrch')}}" id="form1" method="POST" style="display : block; margin-top : 15px;">
        @csrf
        ...
        <input type="text" class="form-control" placeholder="Tulis nama pengarang" name="search" aria-label="searchauthor" aria-describedby="basic-addon1">
        <div class="input-group-append">
            ...
            <div class="row" style="margin-top : 30px;">
                ...
                <div class="offset-md-5 col-md-2">
                    <a class="add-new" href="{{route('addauthor')}}">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <thead class="lighten-2" style="background-color :#428bca; color : white; border-radius: 3px;">
                        <tr>
                        <th scope="col">Bil</th>
                        <th scope="col" style="width : 70%;">Nama Pengarang</th>
                        <th scope="col">Modify</th>
                        </tr>
                    </thead>
                    <tbody>
                    <?php $key = 1; ?>
                        @forelse ($data as $auther)
                        <tr>
                        <th scope="row">{{ $key++ }}</th>
                        <td>{{ $auther->name }}</td>
                        <td>
                            <a href="/modifyAuthors/{{ $auther->id }}">
